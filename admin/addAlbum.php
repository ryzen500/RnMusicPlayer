                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Masukkan Nama Album </label>
...
?>
  ...
  <input class="form-control" type="file" name="artworkPath" id="formFile">
</div>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="submit">Simpan Album</button>
