            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Music Was Publish</p>
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <!-- <p class="card-category">Date : <?//php echo date('Y-m-d H:i:s'); ?></p> -->
                  Date :<div id="clock"></div>
                </div>
                <div class="card-body table-responsive">
          <a href="addUser.php"><button class="btn btn-primary"> <i class="fa-solid fa-plus"></i> Add User</button></a>
                  ...
                  ?>
                    <tbody>   
                      <tr>
                       ...
                       <td><a href="formEdit/updateUser.php?id=<?php echo $datas['id']; ?>"><button class="btn btn-primary" onclick="return confirm('Anda Yakin ingin Merubah Data User');">Edit</button></a></td>
                       <td><a href="deletedUser.php?id=<?php echo $datas['id']; ?>"><button class="btn btn-warning" onclick="return confirm('Anda Yakin ingin Menghapus Data User');">Hapus</button></a></td>
