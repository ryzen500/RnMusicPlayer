                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="title" placeholder="Masukkkan Judul Lagu">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
...
?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="duration" placeholder="Masukan Durasi Musik yang diupload (Ex:03:40)">
                        </div>
                      </div>
                    </div>
                    <div class="row">
