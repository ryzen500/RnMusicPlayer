            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Add New Artist</p>
                </div>
                <div class="card-body">
                  <form action="processingArtist.php" method="POST"  enctype="multipart/form-data">
                   

                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Masukkan Artist Music </label>
