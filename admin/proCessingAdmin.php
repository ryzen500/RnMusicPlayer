...
if(isset($_POST['submit'])){
	...
	if (isset($_POST['ubahpassword'])) {
		...
		if($query2){
			...
			$sql = "UPDATE `admin` SET username='$username', firstName='$firstName', lastName = '$lastName',  signUpDate='$signUpDate',profilePic='$profilePic', descripsi= '$descripsi' WHERE id ='$id'";
			$query2 =mysqli_query($con,$sql);
			// var_dump($sql);
			if($query2){
				echo 'FILE BERHASIL DI UPLOAD';
