<?php
	class adminAccount {
		...
		public function getEmail() {
			$query = mysqli_query($this->con, "SELECT email FROM admin WHERE username='$this->username'");
		...
		private function insertUserDetails($un, $fn, $ln, $em, $pw) {
			...
			$result = mysqli_query($this->con, "INSERT INTO admin VALUES ('', '$un', '$fn', '$ln', '$em', '$encryptedPw', '$date', '$profilePic')");
